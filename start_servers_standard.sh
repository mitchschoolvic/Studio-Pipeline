...
# Studio Pipeline - Server Startup Script (STANDARD MODE)
# This script starts both the backend API and frontend dev server without AI analytics

set -e  # Exit on error

# Disable AI features
export BUILD_WITH_AI=false
...
echo "🚀 Starting Studio Pipeline Servers (STANDARD MODE)..."
echo "   📹 Standard video processing only"
echo ""
...
# Step 2: Start Backend in standard mode
echo "🔧 Starting Backend API Server (STANDARD MODE)..."
cd "$BACKEND_DIR"
nohup "$VENV_PATH/bin/python" -m uvicorn main:app --host 0.0.0.0 --port 8000 --log-level info > /tmp/backend_standard.log 2>&1 &
BACKEND_PID=$!
echo "   Backend PID: $BACKEND_PID"
echo "   Logs: /tmp/backend_standard.log"
...
if [ -z "$REUSE_FRONTEND" ]; then
    nohup ./node_modules/.bin/vite --host 0.0.0.0 --port 5173 > /tmp/vite_server.log 2>&1 &
    FRONTEND_PID=$!
...
# Step 4: Summary
echo ""
echo "✅ All servers started successfully (STANDARD MODE)!"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo ""
echo "📝 View Logs:"
echo "  tail -f /tmp/backend_standard.log"
echo "  tail -f /tmp/vite_server.log"
echo ""
echo "🛑 Stop Servers:"
echo "  ./stop_servers_standard.sh"
echo ""
