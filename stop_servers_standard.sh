...
# Studio Pipeline - Server Shutdown Script (STANDARD MODE)
# This script stops both the backend API and frontend dev server

echo "🛑 Stopping Studio Pipeline Servers (STANDARD MODE)..."
...
echo ""
echo "✅ All servers stopped (STANDARD MODE)!"
echo ""
echo "📝 Logs preserved at:"
echo "  /tmp/backend_standard.log"
